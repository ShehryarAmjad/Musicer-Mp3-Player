#! python3
"""
@created: 2024-07-18 12:05:36
@author: Shehryar Amjad
...
-------------------------------------------------------------------------------
Description : 
Musicer MP3 Player is a python tkinter based music player which you can use to
...
class Player(tk.Frame):
	...
	def track_widgets(self):
		...
		self.songtrack['text'] = 'Musicer MP3 Player'
